...
/*
Aqui encontramos maximos, minimos y tiempos.
Se puede indentificar cada task
...
/*** Funcion tipo int
** Se toma un int dentro de un string
** Retorna el valor entero 
** Parsea nuestro string
** 
*/
...
/*** Funcion tipo void
** Muestra en pantalla la configuracion de los tasks
** No retorna un valor
** Se realiza en cada task
** 
*/
...
/*** Funcion tipo void
** Muestra en pantalla la configuracion
** de task especifico 
** No retorna un valor
** 
*/
...
** No retorna un valor
** Se realiza en cada task
** La diferencia es el uso de get_casio_task_config_info
*/
...
int main(int argc, char *argv[])
{
	...
	/* Se da a conocer
	informacion de los casio_tasks */
